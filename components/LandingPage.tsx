...
const LandingPage: React.FC<LandingPageProps> = ({ onStart, onDemo }) => {
  ...
  return (
    <div className="overflow-hidden bg-black min-h-screen text-white">
      ...
      >
        ...
        >
          ...
          <div className="relative mb-12">
             <h1 className="text-6xl md:text-[8rem] font-black leading-none tracking-tighter mb-6 relative z-10 text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-gray-500 reveal">
              Chatbot
              <br />
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-16 max-w-3xl mx-auto leading-relaxed font-light reveal delay-100">
      ...
      {/* Infinite Marquee */}
      <section className="py-12 bg-white/5 border-y border-white/5 backdrop-blur-sm overflow-hidden mb-32 rotate-1 scale-105">
      ...
      <section className="py-20 relative px-6">
         <div className="container mx-auto">
            <h2 className="text-5xl md:text-7xl font-black mb-20 text-center reveal">
              <span className="text-gray-500">Why</span> Leaders <span className="text-purple-400">Choose Dora</span>
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
               <div className="md:col-span-2 glass-panel rounded-[3rem] p-12 relative overflow-hidden group reveal">
                  <div className="absolute top-0 right-0 p-10 opacity-10 group-hover:opacity-30 transition transform group-hover:scale-110 duration-700">
                     <Command className="w-64 h-64 text-purple-500" />
                  </div>
                  <div className="relative z-10">
                     <div className="w-16 h-16 bg-purple-500/20 rounded-2xl flex items-center justify-center mb-8 backdrop-blur-md">
                        <Zap className="w-8 h-8 text-purple-400" />
                     </div>
                     <h3 className="text-4xl font-bold mb-4">Instant Neural Processing</h3>
                     <p className="text-xl text-gray-400 max-w-md">Our Gemini-powered engine processes intent in &lt;100ms, faster than human perception.</p>
                  </div>
               </div>

               <div className="md:col-span-1 glass-panel rounded-[3rem] p-12 flex flex-col justify-between group reveal delay-100">
                  <div className="w-16 h-16 bg-pink-500/20 rounded-2xl flex items-center justify-center mb-8 backdrop-blur-md">
                     <Shield className="w-8 h-8 text-pink-400" />
                  </div>
                  <div>
                     <h3 className="text-3xl font-bold mb-4">Enterprise Secure</h3>
                     <p className="text-gray-400">SOC2 Type II certified with end-to-end encryption for all data streams.</p>
                  </div>
               </div>

               <div className="md:col-span-1 glass-panel rounded-[3rem] p-12 group reveal delay-200">
                  <div className="w-16 h-16 bg-blue-500/20 rounded-2xl flex items-center justify-center mb-8 backdrop-blur-md">
                     <Globe className="w-8 h-8 text-blue-400" />
                  </div>
                  <h3 className="text-3xl font-bold mb-4">Multilingual</h3>
                  <p className="text-gray-400">Native fluency in 95+ languages without external translation APIs.</p>
               </div>

               <div className="md:col-span-2 glass-panel rounded-[3rem] p-12 flex items-center relative overflow-hidden group reveal delay-300">
                  ...
                  <div className="relative z-10 w-full">
                     <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                           <div className="w-16 h-16 bg-green-500/20 rounded-2xl flex items-center justify-center mb-8 backdrop-blur-md">
                              <BarChart3 className="w-8 h-8 text-green-400" />
                           </div>
                           <h3 className="text-4xl font-bold mb-4">Actionable Analytics</h3>
                           <p className="text-xl text-gray-400 max-w-md">Real-time sentiment analysis and conversation drop-off heatmaps.</p>
                        </div>
                        <div className="bg-black/40 p-6 rounded-2xl border border-white/10 w-full md:w-64 backdrop-blur-sm transform rotate-3 group-hover:rotate-0 transition duration-500">
      ...
      <section className="py-32 px-6">
        <div className="container mx-auto">
          <div className="glass-panel max-w-5xl mx-auto rounded-[3rem] overflow-hidden border border-white/10 reveal">
             <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="p-12 md:p-20 flex flex-col justify-center">
                   <h2 className="text-4xl md:text-5xl font-black mb-6">Drop-in <br /><span className="text-purple-400">Integration</span></h2>
                   <p className="text-gray-400 text-lg mb-8">Add Dora to your site in 30 seconds. Works with React, Vue, HTML, and more.</p>
                   <div className="flex items-center space-x-4">
                      {['React', 'Vue', 'Next.js', 'WordPress'].map((tech) => (
                         <span key={tech} className="px-4 py-2 bg-white/5 rounded-full text-xs font-bold text-gray-400 border border-white/5">{tech}</span>
                      ))}
                   </div>
                </div>
                <div className="bg-[#050505] p-12 font-mono text-sm overflow-hidden relative group">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-40">
        ...
        <div className="container mx-auto px-6 relative z-10 perspective-2000 preserve-3d">
          <div className="flex flex-col items-center">
            ...
            <div className="relative w-full max-w-6xl h-[700px] mb-20 flex items-center justify-center reveal">
               ...
               <div className="absolute top-[5%] left-[0%] md:left-[10%] w-96 h-56 glass-module rounded-[3rem] p-8 animate-float shadow-2xl z-30 group cursor-pointer hover:scale-105 transition-all duration-500">
                  ...
                  <div className="h-24 w-full flex items-end gap-2">
                     {[30, 60, 40, 100, 70, 90, 80, 120].map((h, i) => (
                        <div 
                          key={i} 
                          className="flex-1 bg-gradient-to-t from-purple-600 to-pink-500 rounded-t-lg transition-all duration-700" 
                          style={{ height: `${(h/120)*100}%`, opacity: 0.4 + (i * 0.08) }}
                        ></div>
                     ))}
                  </div>
                  <div className="mt-6 flex items-center justify-between overflow-hidden">
                     <span className="text-2x font-black text-white">$142,850.00</span>
               ...
               <div className="absolute top-[5%] right-[0%] md:right-[10%] w-96 h-56 glass-module rounded-[3rem] p-8 animate-float [animation-delay:1s] shadow-2xl z-30 group cursor-pointer hover:scale-105 transition-all duration-500">
                  ...
                  <div className="flex items-center justify-center gap-6 relative overflow-hidden h-16">
                     {[...Array(4)].map((_, i) => (
                        <div 
                          key={i} 
                          className="w-14 h-14 rounded-2xl border border-white/20 bg-white/10 flex items-center justify-center shrink-0 transition-all duration-700"
                          style={{ 
                  ...
                  <div className="mt-6 text-center">
                     <span className="text-sm font-bold text-gray-400 tracking-wide">Flowing <span className="text-white group-hover:text-purple-400 transition-colors">842</span> agents / min</span>
                  </div>
               </div>

               {/* Segment 3: Logic Stream (Enlarged) */}
               <div className="absolute bottom-[0%] left-[0%] md:left-[5%] w-[450px] h-48 glass-module rounded-[3rem] p-8 animate-float [animation-delay:2s] shadow-2xl z-30 group cursor-pointer hover:scale-105 transition-all duration-500">
               ...
               <div className="absolute bottom-[0%] right-[0%] md:right-[5%] w-[450px] h-48 glass-module rounded-[3rem] p-8 animate-float [animation-delay:1.5s] shadow-2xl z-30 group cursor-pointer hover:scale-105 transition-all duration-500">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                     <div className="text-center p-4 rounded-3xl bg-white/5 border border-white/5 group-hover:border-yellow-400/30 transition-colors">
                        <div className="text-[10px] text-gray-500 uppercase mb-1">Response</div>
                        <div className="text-xl font-black text-yellow-400 transition-all group-hover:scale-110">0.4s</div>
                     </div>
                     <div className="text-center p-4 rounded-3xl bg-white/5 border border-white/5 group-hover:border-white/30 transition-colors">
                        <div className="text-[10px] text-gray-500 uppercase mb-1">ROI</div>
                        <div className="text-xl font-black text-white transition-all group-hover:scale-110">12x</div>
                     </div>
                     <div className="text-center p-4 rounded-3xl bg-white/5 border border-white/5 group-hover:border-green-400/30 transition-colors">
                        <div className="text-[10px] text-gray-500 uppercase mb-1">Uptime</div>
                        <div className="text-xl font-black text-green-400 transition-all group-hover:scale-110">100%</div>
                     </div>
                  </div>
               </div>
            ...
            <div className="reveal delay-500 mt-10">
               <button 
                 onClick={onStart}
                 className="px-12 py-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full font-bold text-xl hover:bg-white/10 transition-all text-white flex items-center gap-4 group"
               >
